...
@interface LazyScrollViewController ()<TMMuiLazyScrollViewDataSource> {
...
- (void)viewDidLoad {
    ...
    TMMuiLazyScrollView *lazyScrollView = [[TMMuiLazyScrollView alloc] init];
    lazyScrollView.backgroundColor = J_COLOR_RED;
    ...
    lazyScrollView.contentSize = CGSizeMake(CGRectGetWidth(self.view.bounds), 1230);
