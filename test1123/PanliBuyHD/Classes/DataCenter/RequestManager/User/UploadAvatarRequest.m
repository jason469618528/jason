...
{
    //拼接URL
    NSString *url = [BASE_URL stringByAppendingString:RQNAME_USER_UPLOADAVATAR];
    ...
    //上传图片
    [((ASIFormDataRequest *)self.request) setFile:[repeater.requestParameters valueForKey:RQ_USER_UPLOADAVATAR_PARM_PICFILE] forKey:RQ_USER_UPLOADAVATAR_PARM_PICFILE];
