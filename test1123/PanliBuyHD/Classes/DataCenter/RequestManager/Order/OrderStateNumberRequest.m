...
#import "OrderStateNumberRequest.h"

@implementation OrderStateNumberRequest
...
{
    //拼接URL
    NSString *url = [BASE_URL stringByAppendingString:RQNAME_GETORDERSSTATENUMBER];
