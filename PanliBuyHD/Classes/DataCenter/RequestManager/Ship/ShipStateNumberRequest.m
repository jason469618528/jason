...
#import "ShipStateNumberRequest.h"

@implementation ShipStateNumberRequest
...
{
    //拼接URL
    NSString *url = [BASE_URL stringByAppendingString:RQNAME_STATENUMBER];
