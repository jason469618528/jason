...
@implementation RechargeInfoRequest
...
{
    //拼接URL
    NSString *url = [BASE_URL stringByAppendingString:RQNAME_RECHARGEINFO];
...
- (ErrorInfo *)checkResponseError:(NSDictionary*)jsonValue
{
    ...
    if (errorInfo.code == SERVER_SUCCESS)
    {
        ...
        {
            errorInfo.code = 99;
            errorInfo.message = LocalizedString(@"RechargeInfoRequest_ErrorInfo_code99",@"Paypal充值功能关闭");
        }
        else
        {
