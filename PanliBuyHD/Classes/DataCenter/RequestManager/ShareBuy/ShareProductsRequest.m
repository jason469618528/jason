//
//  ShareProductsRequest.m
//  PanliApp
//
//  Created by jason on 13-12-12.
//  Copyright (c) 2013年 Panli. All rights reserved.
//

#import "ShareProductsRequest.h"
#import "ShareProduct.h"
#import "PageData.h"
@implementation ShareProductsRequest
...
{
    //拼接URL
    NSString *url = [BASE_URL stringByAppendingString:@"Share/ShareProducts.json"];
...
- (void)receive:(ASIHTTPRequest *)request
{
    ...
    if (errorInfo.code == API_SUCCESS)
    {
        ...
        if(arr_ShareInfo != nil)
        {
            ...
            mPageData.list = marr_ShareInfo;
            [marr_ShareInfo release];
            
        }
        
        mPageData.hasNext = [[resultArray objectForKey:@"hasNext"] boolValue];
